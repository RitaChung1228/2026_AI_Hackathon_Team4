...
export default function ContextPanel({
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", overflowY: "auto", display: "flex", flexDirection: "column" }}>
        <div style={{ position: "relative", height: 150, flexShrink: 0, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(27,42,56,0.2), rgba(27,42,56,0.75))" }} />
        ...
        <div style={{ padding: "14px 14px 0" }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.8px", marginBottom: 10, fontFamily: "var(--font-display)" }}>快速啟動</div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 8, padding: "0 14px 16px" }}>
          {quickPacks.map((pack) => (
            <div key={pack.id} style={{ borderRadius: 12, overflow: "hidden", border: "1px solid #E2E8F0", cursor: "pointer", position: "relative" }}>
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", height: 140, flexShrink: 0, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(22,35,46,0.85))" }} />
          <div style={{ position: "absolute", top: 10, left: 12, display: "flex", alignItems: "center", gap: 5, background: "rgba(76,110,145,0.9)", padding: "4px 10px 4px 8px", borderRadius: 20 }}>
          ...
          <div style={{ position: "absolute", bottom: -18, right: 16, width: 52, height: 52, borderRadius: "50%", background: `conic-gradient(#4C6E91 ${ringDeg}deg, rgba(255,255,255,0.28) 0deg)`, padding: 4, boxShadow: "0 6px 16px rgba(22,35,46,0.35)" }}>
            <div style={{ width: "100%", height: "100%", borderRadius: "50%", background: "white", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ fontSize: 13, fontWeight: 800, color: "#4C6E91", fontFamily: "var(--font-display)" }}>{prog}%</span>
            </div>
          </div>
        </div>

        {/* Overall progress */}
        <div style={{ padding: "26px 16px 10px", background: "white", borderBottom: "1px solid #F1F5F9", flexShrink: 0 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
            <span style={{ fontSize: 11, fontWeight: 700, color: "#64748B", fontFamily: "var(--font-display)" }}>整體進度</span>
            <span style={{ fontSize: 11, color: "#94A3B8" }}>{confirmedCount}/{tasks.length} 已完成</span>
          </div>
          <div style={{ height: 5, background: "#F1F5F9", borderRadius: 3, overflow: "hidden" }}>
            <div style={{ height: "100%", width: `${prog}%`, background: "linear-gradient(90deg, #4C6E91, #6E92B4)", borderRadius: 3, transition: "width 0.5s ease" }} />
          </div>
        </div>
        ...
        <div style={{ flex: 1, overflowY: "auto" }} className="scrollbar-hide">
          ...
          {agentMission.aiSummary && (
            <div style={{ margin: "12px 16px 0", padding: "12px 14px", background: "linear-gradient(135deg, rgba(76,110,145,0.07), rgba(110,146,180,0.04))", border: "1px solid rgba(76,110,145,0.15)", borderRadius: 14 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 6 }}>
                <SparkleIcon size={13} color="#4C6E91" />
                <span style={{ fontSize: 11, fontWeight: 700, color: "#4C6E91", fontFamily: "var(--font-display)" }}>AI 摘要</span>
              </div>
              <div style={{ fontSize: 12, color: "#334155", lineHeight: 1.5, marginBottom: 10 }}>{agentMission.aiSummary}</div>
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                {[
                  ...
                  <button
                    ...
                    style={{ fontSize: 11, fontWeight: 600, padding: "5px 11px", borderRadius: 20, border: "1.5px solid rgba(76,110,145,0.3)", background: "white", color: "#4C6E91", cursor: "pointer", fontFamily: "var(--font-display)" }}
                  >
                    {chip.label}
                  </button>
                ))}
                <button
                  onClick={handleShare}
                  style={{ fontSize: 11, fontWeight: 600, padding: "5px 11px", borderRadius: 20, border: "1.5px solid rgba(76,110,145,0.3)", background: "white", color: "#4C6E91", cursor: "pointer", fontFamily: "var(--font-display)", display: "flex", alignItems: "center", gap: 4 }}
                >
                  {shareCopied && <CheckIcon size={12} color="#4C6E91" />}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 16px 8px" }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)" }}>AI 規劃清單 ({tasks.length})</span>
              ...
              {AGENT_TASK_FILTERS.map((f) => (
                <button
                  ...
                  style={{
                    ...
                    background: agentTaskFilter === f.id ? "#4C6E91" : "#F1F5F9",
                    color: agentTaskFilter === f.id ? "white" : "#94A3B8",
                  }}
                >
                  {f.label}
                </button>
          ...
          <div style={{ padding: "0 16px 16px", display: "flex", flexDirection: "column", gap: 8 }}>
            {filteredTasks.map((task: any) => {
              ...
              return (
                <div
                  ...
                  style={{ background: "white", borderRadius: 12, border: "1px solid #F1F5F9", overflow: "hidden", cursor: "pointer" }}
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 14px" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 13, color: "#16232E", marginBottom: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{task.title}</div>
                      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                        ...
                        <span style={{ fontSize: 11, color: "#64748B", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{task.detail}</span>
                      </div>
                    </div>
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, flexShrink: 0 }}>
                      ...
                      <Icon icon="solar:alt-arrow-right-bold-duotone" width={14} height={14} style={{ color: "#A9C0D6" }} />
                    </div>
                  </div>
                </div>
              );
            ...
            {filteredTasks.length === 0 && (
              <div style={{ fontSize: 12, color: "#A9C0D6", textAlign: "center", padding: "24px 0" }}>這個篩選條件下沒有任務</div>
            )}
          </div>
        </div>

        {/* Bottom CTA back to chat */}
        <div style={{ flexShrink: 0, margin: "0 16px 16px", padding: "12px 14px", borderRadius: 14, background: "linear-gradient(135deg, #4C6E91, #6E92B4)", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <button
            onClick={() => onOpenChat?.()}
            style={{ fontSize: 11, fontWeight: 700, padding: "7px 14px", borderRadius: 20, border: "none", background: "white", color: "#4C6E91", cursor: "pointer", fontFamily: "var(--font-display)", flexShrink: 0, whiteSpace: "nowrap" }}
          >
            與 UNI 對話
          </button>
        </div>
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", height: 130, flexShrink: 0, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(0,0,0,0.1), rgba(22,35,46,0.82))" }} />
          <div style={{ position: "absolute", bottom: 12, left: 16, right: 16 }}>
            ...
            <div style={{ height: 3, background: "rgba(255,255,255,0.2)", borderRadius: 2, overflow: "hidden" }}>
              <div style={{ height: "100%", width: `${prog}%`, background: "linear-gradient(90deg, #8FB0CC, #6E92B4)", borderRadius: 2, transition: "width 0.5s" }} />
            </div>
        ...
        {/* AI note */}
        {mission.aiSummary && (
          <div style={{ margin: "10px 12px 0", background: "linear-gradient(135deg, rgba(76,110,145,0.07), rgba(110,146,180,0.04))", border: "1px solid rgba(76,110,145,0.14)", borderRadius: 10, padding: "8px 12px", display: "flex", gap: 8, flexShrink: 0 }}>
            <SparkleIcon size={13} color="#4C6E91" />
            <p style={{ fontSize: 12, color: "#4C6E91", margin: 0, lineHeight: 1.5, fontWeight: 500 }}>{mission.aiSummary}</p>
          </div>
        )}
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "10px 12px" }} className="scrollbar-hide">
          <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
            {mission.tasks.map((task: Task) => {
              ...
              return (
                <div key={task.id} className="msg-enter" style={{ background: "white", borderRadius: 12, border: isExpanded ? "1.5px solid rgba(76,110,145,0.25)" : "1px solid #F1F5F9", overflow: "hidden", transition: "border-color 0.2s" }}>
                  {/* Task header */}
                  <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 13, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)" }}>{task.title}</div>
                      <div style={{ fontSize: 11, color: "#64748B", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{detail}</div>
                    </div>
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, flexShrink: 0 }}>
                      ...
                      <button
                        ...
                        style={{ fontSize: 11, color: isExpanded ? "#6E92B4" : "#4C6E91", fontWeight: 600, background: "none", border: "none", cursor: "pointer", fontFamily: "var(--font-display)", padding: 0 }}
                      >
                  ...
                  {isExpanded && (recs.length > 0 || task.id === "diagnose" || task.id === "cake" || task.id === "notify" || (task.id === "checklist" && view === "moving") || (task.id === "schedule" && view === "fitness") || (task.id === "nutrition" && view === "fitness")) && (
                    <div style={{ borderTop: "1px solid #F1F5F9", background: "#FAFCFE", padding: "8px 10px 10px" }}>
                      ...
                      {task.id === "cake" && (() => {
                        ...
                        return (
                          <div style={{ marginBottom: 10 }}>
                            <div style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.6px", marginBottom: 8, fontFamily: "var(--font-display)" }}>🎂 選擇吋數</div>
                              ...
                              {SIZES.map((s) => (
                                <button
                                  ...
                                  style={{
                                    ...
                                    borderColor: cakeSize === s ? "#4C6E91" : "#E2E8F0",
                                    background: cakeSize === s ? "#E7EEF5" : "white",
                                    color: cakeSize === s ? "#4C6E91" : "#64748B",
                            ...
                            {sizeRecs.length > 0 && (
                              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                                {sizeRecs.map((rec) => {
                                  ...
                                  return (
                                    <div key={rec.id} style={{ display: "flex", alignItems: "center", gap: 8, background: "white", borderRadius: 10, padding: "8px 10px", border: "1px solid #F1F5F9" }}>
                                      <span style={{ fontSize: 18, flexShrink: 0 }}>{rec.icon}</span>
                                      <div style={{ flex: 1, minWidth: 0 }}>
                                        <div style={{ fontSize: 12, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)" }}>{rec.name}</div>
                                        <div style={{ fontSize: 10, color: "#94A3B8" }}>{rec.detail}</div>
                                      </div>
                                      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, flexShrink: 0 }}>
                                        <span style={{ fontSize: 11, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)" }}>NT${rec.price}</span>
                                        <button
                                          onClick={() => {
                                            if (inCart) return;
                                          ...
                                          style={{
                                            ...
                                            background: inCart ? "#DCFCE7" : "#4C6E91",
                            ...
                            {!cakeSize && (
                              <div style={{ fontSize: 11, color: "#94A3B8", textAlign: "center", padding: "6px 0" }}>請先選擇吋數查看推薦 ↑</div>
                            )}
                      ...
                      {task.id === "checklist" && view === "moving" && (
                        <div style={{ marginBottom: 6 }}>
                          <div style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.6px", marginBottom: 8, fontFamily: "var(--font-display)" }}>📋 搬家項目清單</div>
                          <div style={{ display: "flex", gap: 6, marginBottom: 8 }}>
                            <input
                              ...
                              style={{
                                ...
                                border: "1.5px solid #E2E8F0", fontSize: 13, color: "#16232E",
                                fontFamily: "var(--font-body)", outline: "none", background: "white",
                              }}
                              onFocus={(e) => (e.currentTarget.style.borderColor = "#4C6E91")}
                            ...
                            <button
                              ...
                              style={{
                                ...
                                background: checklistInput.trim() ? "#4C6E91" : "#E2E8F0",
                          ...
                          {checklistItems.length > 0 && (
                            <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                              {checklistItems.map((item, i) => (
                                <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, background: "white", borderRadius: 9, padding: "7px 10px", border: "1px solid #F1F5F9" }}>
                                  <div style={{ width: 16, height: 16, borderRadius: "50%", border: "1.5px solid #CBD5E1", flexShrink: 0 }} />
                                  <span style={{ flex: 1, fontSize: 13, color: "#16232E", fontFamily: "var(--font-body)" }}>{item}</span>
                                  <button
                          ...
                          {checklistItems.length === 0 && (
                            <div style={{ fontSize: 11, color: "#A9C0D6", textAlign: "center", padding: "6px 0" }}>還沒有項目，輸入後按上方按鈕加入</div>
                          )}
                        </div>
                      )}
                      ...
                      {task.id === "notify" && (
                        <div style={{ marginBottom: 6 }}>
                          <div style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.6px", marginBottom: 8, fontFamily: "var(--font-display)" }}>📮 輸入新地址</div>
                          <input
                            value={newAddress}
                          ...
                          <button
                            ...
                            style={{
                              ...
                              background: newAddress.trim() ? "linear-gradient(135deg, #4C6E91, #6E92B4)" : "#E2E8F0",
                              color: newAddress.trim() ? "white" : "#94A3B8",
                      ...
                      {task.id === "diagnose" && (
                        <div style={{ marginBottom: 10 }}>
                          <div style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.6px", marginBottom: 8, fontFamily: "var(--font-display)" }}>📷 問題照片</div>
                          <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                            ...
                            <button
                              ...
                              style={{ width: 64, height: 64, borderRadius: 8, border: "1.5px dashed #A9C0D6", background: "white", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 3, color: "#6E92B4", flexShrink: 0 }}
                            >
                              <PlusIcon size={18} />
                          ...
                          {uploadedPhotos.length > 0 && (
                            <div style={{ marginTop: 8, display: "flex", alignItems: "center", gap: 6, background: "#E7EEF5", borderRadius: 8, padding: "5px 8px" }}>
                              <SparkleIcon size={11} color="#4C6E91" />
                              <span style={{ fontSize: 10, color: "#4C6E91", fontWeight: 600, fontFamily: "var(--font-display)" }}>AI 已收到 {uploadedPhotos.length} 張照片，正在分析問題...</span>
                            </div>
                          )}
                        </div>
                      )}
                      ...
                      {task.id === "nutrition" && view === "fitness" && (() => {
                        ...
                        const TAG_COLORS: Record<string, string> = { 蛋白質: "#4C6E91", 碳水: "#0EA5E9", 好油: "#F59E0B", 蔬菜: "#16A34A", 水果: "#EC4899" };
                        return (
                          <div style={{ marginBottom: 6 }}>
                            <div style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.6px", marginBottom: 8, fontFamily: "var(--font-display)" }}>🔥 每日目標攝取</div>
                            <div style={{ display: "flex", gap: 6, alignItems: "center", marginBottom: 10 }}>
                              <input
                                ...
                                onBlur={(e) => (e.currentTarget.style.borderColor = "#E2E8F0")}
                              />
                              <span style={{ fontSize: 12, color: "#94A3B8", fontFamily: "var(--font-display)", flexShrink: 0 }}>kcal</span>
                              <button
                                onClick={() => { if (parseInt(calorieGoal) > 0) setCalorieConfirmed(true); }}
                                style={{
                                  padding: "9px 14px", borderRadius: 10, border: "none", flexShrink: 0,
                                  background: parseInt(calorieGoal) > 0 ? "linear-gradient(135deg, #4C6E91, #6E92B4)" : "#E2E8F0",
                                  color: parseInt(calorieGoal) > 0 ? "white" : "#94A3B8",
                            ...
                            {calorieConfirmed && kcal > 0 && (
                              <>
                                <div style={{ display: "flex", gap: 6, marginBottom: 10 }}>
                                  {[["蛋白質", `${protein}g`, "#4C6E91"], ["碳水", `${carbs}g`, "#0EA5E9"], ["脂肪", `${fat}g`, "#F59E0B"]].map(([label, val, color]) => (
                                    <div key={label} style={{ flex: 1, background: "white", borderRadius: 9, padding: "7px 8px", border: "1px solid #F1F5F9", textAlign: "center" }}>
                                      <div style={{ fontSize: 14, fontWeight: 800, color, fontFamily: "var(--font-display)" }}>{val}</div>
                                      <div style={{ fontSize: 9, color: "#94A3B8", fontFamily: "var(--font-display)", marginTop: 1 }}>{label}</div>
                                    </div>
                                  ))}
                                </div>
                                <div style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.6px", marginBottom: 6, fontFamily: "var(--font-display)", display: "flex", alignItems: "center", gap: 4 }}><SparkleIcon size={11} />AI 推薦食物</div>
                                <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                                  {FOOD_RECS.map((food) => (
                                    <div key={food.name} style={{ display: "flex", alignItems: "center", gap: 8, background: "white", borderRadius: 10, padding: "8px 10px", border: "1px solid #F1F5F9" }}>
                                      <span style={{ fontSize: 18, flexShrink: 0 }}>{food.icon}</span>
                                      <div style={{ flex: 1, minWidth: 0 }}>
                                        <div style={{ fontSize: 12, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)" }}>{food.name}</div>
                                        <div style={{ fontSize: 10, color: "#94A3B8" }}>{food.detail}</div>
                                      </div>
                                      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 3, flexShrink: 0 }}>
                                        ...
                                        <span style={{ fontSize: 10, color: "#64748B", fontFamily: "var(--font-display)" }}>{food.kcal} kcal</span>
                                      </div>
                                    </div>
                                  ))}
                                </div>
                            ...
                            {!calorieConfirmed && (
                              <div style={{ fontSize: 11, color: "#A9C0D6", textAlign: "center", padding: "4px 0", fontFamily: "var(--font-display)" }}>輸入卡路里後 AI 將推薦適合食物</div>
                            )}
                          </div>
                        );
                      })()}
                      ...
                      {task.id === "schedule" && view === "fitness" && (
                        <div style={{ marginBottom: 6 }}>
                          <div style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.6px", marginBottom: 8, fontFamily: "var(--font-display)" }}>📅 本週訓練課表</div>
                          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                            {DAYS.map((day) => (
                              <div key={day} style={{ display: "flex", alignItems: "center", gap: 8, background: "white", borderRadius: 10, padding: "8px 10px", border: "1px solid #F1F5F9" }}>
                                <div style={{ width: 40, fontSize: 12, fontWeight: 700, color: workoutSchedule[day] === "休息" ? "#94A3B8" : "#4C6E91", fontFamily: "var(--font-display)", flexShrink: 0 }}>{day.replace("星期", "週")}</div>
                                <select
                                  value={workoutSchedule[day]}
                                  onChange={(e) => setWorkoutSchedule((prev) => ({ ...prev, [day]: e.target.value }))}
                                  style={{
                                    flex: 1, padding: "5px 8px", borderRadius: 8, border: "1.5px solid #E2E8F0",
                                    fontSize: 12, color: workoutSchedule[day] === "休息" ? "#94A3B8" : "#16232E",
                          ...
                          <div style={{ marginTop: 8, padding: "6px 10px", background: "#E7EEF5", borderRadius: 8, fontSize: 10, color: "#4C6E91", fontWeight: 600, fontFamily: "var(--font-display)", display: "flex", alignItems: "center", gap: 4 }}>
                          ...
                          {recs.map((rec) => {
                            ...
                            return (
                              <div key={rec.id} style={{ display: "flex", alignItems: "center", gap: 8, background: "white", borderRadius: 10, padding: "8px 10px", border: "1px solid #F1F5F9" }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, flexShrink: 0 }}>
                                  {rec.price > 0 && <span style={{ fontSize: 11, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)" }}>NT${rec.price}</span>}
                                  <button
                                    onClick={() => {
                                      if (inCart) return;
                                      onProductAdd({ id: rec.id, name: rec.name, detail: rec.detail, price: rec.price, qty: 1, icon: rec.icon });
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", overflowY: "auto" }}>
        <div style={{ position: "relative", height: 130, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(76,110,145,0.75), rgba(110,146,180,0.6))" }} />
        ...
        <div style={{ padding: 14 }}>
          <div style={{ background: "white", borderRadius: 12, padding: 14, marginBottom: 10, border: "1px solid #F1F5F9" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.8px", marginBottom: 10, fontFamily: "var(--font-display)" }}>DYNAMIC TAGS</div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {tags.map((t) => <span key={t} style={{ padding: "4px 10px", borderRadius: 20, background: "#E7EEF5", color: "#4C6E91", fontSize: 12, fontWeight: 600, fontFamily: "var(--font-display)" }}>{t}</span>)}
            </div>
          </div>
          <div style={{ background: "white", borderRadius: 12, padding: 14, border: "1px solid #F1F5F9" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.8px", marginBottom: 10, fontFamily: "var(--font-display)" }}>偏好設定</div>
            {[["⚡", "優先順序", "速度優先"], ["📦", "取貨方式", "門市取貨"], ["🔔", "通知", "重要才通知"]].map(([icon, label, value]) => (
              <div key={label as string} style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid #F1F5F9" }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 600, color: "#16232E", fontFamily: "var(--font-display)" }}>{value}</span>
              </div>
            ))}
          </div>
        </div>
  ...
  if (view === "missions") {
    const missionData = [
      { icon: "💼", title: "東京商務出差", sub: "進行中 · 65%", prog: 65, color: "#4C6E91", img: UNSPLASH.tokyo },
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", overflowY: "auto", padding: 18 }}>
        <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 14, color: "#16232E", margin: 0, marginBottom: 12 }}>我的任務</h3>
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {missionData.map((m) => (
            <div key={m.title} style={{ borderRadius: 12, overflow: "hidden", border: "1px solid #E2E8F0", background: "white" }}>
  ...
  if (view === "packs") {
    return (
      <div className="panel-enter" style={{ height: "100%", overflowY: "auto", padding: 18 }}>
        <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 14, color: "#16232E", margin: 0, marginBottom: 12 }}>情境包</h3>
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {scenarioPacks.map((p) => (
            <div key={p.id} style={{ borderRadius: 12, overflow: "hidden", border: "1px solid #E2E8F0", cursor: "pointer" }}>
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ position: "relative", height: 90, flexShrink: 0, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "rgba(22,35,46,0.65)", padding: "0 16px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "10px 12px" }} className="scrollbar-hide">
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {shopProducts.map((p: any) => {
              ...
              return (
                <div key={p.id} style={{ background: "white", borderRadius: 12, overflow: "hidden", border: "1px solid #F1F5F9" }}>
                  <div style={{ display: "flex", alignItems: "stretch" }}>
                    <div style={{ width: 76, flexShrink: 0, overflow: "hidden", background: "#F1F5F9" }}>
                      <img src={p.image} alt={p.name} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                    </div>
                    <div style={{ flex: 1, padding: "10px 10px 10px 12px", display: "flex", alignItems: "center", gap: 8 }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 2 }}>
                          <span style={{ fontSize: 13, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)" }}>{p.name}</span>
                          <span style={{ fontSize: 9, fontWeight: 700, color: "#4C6E91", background: "#E7EEF5", padding: "1px 5px", borderRadius: 20 }}>{p.tag}</span>
                        </div>
                        <div style={{ fontSize: 11, color: "#64748B" }}>{p.detail}</div>
                        <div style={{ fontSize: 10, color: "#4C6E91", display: "flex", alignItems: "center", gap: 3, marginTop: 2 }}><SparkleIcon size={10} />{p.reason}</div>
                      </div>
                      <div style={{ textAlign: "right", flexShrink: 0 }}>
                        <div style={{ fontSize: 14, fontWeight: 800, color: "#16232E", fontFamily: "var(--font-display)", marginBottom: 4 }}>NT${p.price}</div>
                        <button
                          onClick={() => addProduct(p)}
                          style={{ padding: "4px 12px", borderRadius: 20, border: added ? "1.5px solid #16A34A" : "none", background: added ? "white" : "#4C6E91", color: added ? "#16A34A" : "white", fontSize: 11, fontWeight: 600, cursor: added ? "default" : "pointer", fontFamily: "var(--font-display)", whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: 3 }}
                        >
        ...
        {cartItems.length > 0 && (
          <div style={{ padding: "10px 12px", borderTop: "1px solid #F1F5F9", flexShrink: 0 }}>
            <button onClick={() => onCartUpdate(cartItems)} style={{ width: "100%", padding: "12px", borderRadius: 12, border: "none", background: "linear-gradient(135deg, #4C6E91, #6E92B4)", color: "white", fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 13, cursor: "pointer" }}>
  ...
  if (view === "cart") {
      ...
      return (
        <div className="panel-enter" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
          <div style={{ padding: "14px 14px 10px", borderBottom: "1px solid #F1F5F9", flexShrink: 0 }}>
            <div style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 15, color: "#16232E" }}>購物車</div>
          </div>
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 32px", textAlign: "center" }}>
            <div style={{ width: 64, height: 64, borderRadius: "50%", background: "#E7EEF5", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
              <Icon icon="solar:cart-large-bold-duotone" width={30} height={30} style={{ color: "#4C6E91" }} />
            </div>
            <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 15, color: "#16232E", marginBottom: 6 }}>
              購物車是空的
            </div>
            <p style={{ fontSize: 13, color: "#64748B", lineHeight: 1.6, margin: 0 }}>
              跟 Lifepack AI 說說你想準備什麼，<br />推薦的商品會出現在這裡。
            </p>
          </div>
        </div>
      );
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "10px 12px" }} className="scrollbar-hide">
          {cartItems.map((item) => (
            <div key={item.id} style={{ background: "white", borderRadius: 12, padding: "10px 12px", marginBottom: 8, border: "1px solid #F1F5F9", display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ fontSize: 18, flexShrink: 0 }}>{item.icon}</span>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: "#16232E", fontFamily: "var(--font-display)" }}>{item.name}</div>
                <div style={{ fontSize: 11, color: "#64748B" }}>{item.detail}</div>
              </div>
              <div style={{ fontSize: 14, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)", flexShrink: 0 }}>NT${item.price}</div>
              <button onClick={() => onCartUpdate(cartItems.filter((i) => i.id !== item.id))} style={{ background: "#F1F5F9", border: "none", borderRadius: "50%", width: 22, height: 22, cursor: "pointer", color: "#94A3B8", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}><CloseIcon size={13} /></button>
            </div>
          ))}
          <div style={{ background: "white", borderRadius: 12, padding: 12, marginBottom: 8, border: "1px solid #F1F5F9" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.8px", marginBottom: 8, fontFamily: "var(--font-display)" }}>選擇取貨門市</div>
            {PICKUP_STORES.map((store) => {
              ...
              return (
                <div
                  ...
                  style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 6px", borderRadius: 10, cursor: "pointer", background: selected ? "#E7EEF5" : "transparent" }}
                >
                  <span style={{ fontSize: 16, flexShrink: 0 }}>{store.icon}</span>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 12, fontWeight: 700, color: "#16232E", fontFamily: "var(--font-display)" }}>{store.chain} {store.name}</div>
                    <div style={{ fontSize: 10, color: "#64748B", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{store.address} · {store.distance}</div>
                  </div>
                  <div style={{ width: 18, height: 18, borderRadius: "50%", border: `2px solid ${selected ? "#4C6E91" : "#CBD5E1"}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    {selected && <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#4C6E91" }} />}
                  </div>
                </div>
              );
            })}
          </div>
          <div style={{ background: "white", borderRadius: 12, padding: 12, border: "1px solid #F1F5F9" }}>
            {[
              ...
              <div key={d.label} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 0", borderBottom: "1px solid #F5F7FA" }}>
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  <span style={{ fontSize: 14 }}>{d.icon}</span>
                  <div>
                    <div style={{ fontSize: 12, fontWeight: 600, color: "#16232E", fontFamily: "var(--font-display)" }}>{d.label}</div>
                    <div style={{ fontSize: 10, color: "#64748B" }}>{d.sub}</div>
                  </div>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <span style={{ fontSize: 12, color: "#16A34A", fontWeight: 600 }}>-NT${d.val}</span>
                  <div onClick={d.toggle} style={{ width: 36, height: 20, borderRadius: 10, background: d.state ? "#4C6E91" : "#CBD5E1", position: "relative", cursor: "pointer", transition: "background 0.2s" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", paddingTop: 10 }}>
              <span style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 14, color: "#16232E" }}>合計</span>
              <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 17, color: "#4C6E91" }}>NT${total.toLocaleString()}</span>
            </div>
          </div>
        </div>
        <div style={{ padding: "10px 12px", borderTop: "1px solid #F1F5F9", flexShrink: 0 }}>
          <button onClick={() => setConfirmingCheckout(true)} style={{ width: "100%", padding: "13px", borderRadius: 12, border: "none", background: "linear-gradient(135deg, #4C6E91, #6E92B4)", color: "white", fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 14, cursor: "pointer", boxShadow: "0 6px 20px rgba(76,110,145,0.35)" }}>
            確認結帳 · NT${total.toLocaleString()}
          </button>
        </div>
        {confirmingCheckout && (
          <div style={{ position: "absolute", inset: 0, background: "rgba(22,35,46,0.5)", display: "flex", alignItems: "flex-end", zIndex: 100 }}>
            <div className="slide-up" style={{ background: "white", borderRadius: "18px 18px 0 0", padding: "22px 22px 36px", width: "100%" }}>
              <div style={{ width: 32, height: 4, borderRadius: 2, background: "#CBD5E1", margin: "0 auto 18px" }} />
              <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 17, textAlign: "center", margin: 0, marginBottom: 6 }}>確認結帳</h3>
              <p style={{ textAlign: "center", fontSize: 13, color: "#64748B", margin: 0 }}>共 {cartItems.length} 件 · NT${total.toLocaleString()}</p>
              <p style={{ textAlign: "center", fontSize: 12, color: "#94A3B8", marginBottom: 18 }}>
                📦 {PICKUP_STORES.find((s) => s.id === selectedStoreId)?.chain} {PICKUP_STORES.find((s) => s.id === selectedStoreId)?.name} 取貨
              </p>
              <button onClick={() => { setConfirmingCheckout(false); onCheckout(); }} style={{ width: "100%", padding: "13px", borderRadius: 12, border: "none", background: "linear-gradient(135deg, #4C6E91, #6E92B4)", color: "white", fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 14, cursor: "pointer", marginBottom: 10 }}>確認付款</button>
              <button onClick={() => setConfirmingCheckout(false)} style={{ width: "100%", padding: "11px", borderRadius: 12, border: "1.5px solid #E2E8F0", background: "white", color: "#64748B", fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>取消</button>
            </div>
          </div>
        )}
      </div>
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", overflowY: "auto" }}>
        <div style={{ position: "relative", height: 130, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "rgba(22,35,46,0.5)", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 8 }}>
        ...
        <div style={{ padding: 14 }}>
          <div style={{ background: "white", borderRadius: 12, padding: 14, marginBottom: 10, border: "1px solid #F1F5F9" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.8px", marginBottom: 10, fontFamily: "var(--font-display)" }}>已完成</div>
            {completed.map((item, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "5px 0" }}>
                ...
                <span style={{ fontSize: 13, color: "#16232E" }}>{item}</span>
              </div>
            ))}
          </div>
          <div style={{ background: "linear-gradient(135deg, rgba(76,110,145,0.07), rgba(110,146,180,0.04))", border: "1px solid rgba(76,110,145,0.14)", borderRadius: 12, padding: 14 }}>
            <p style={{ fontSize: 13, color: "#16232E", margin: 0, marginBottom: 12, fontFamily: "var(--font-display)", fontWeight: 500 }}>
              {isBirthday ? "要儲存成「生日慶祝包」嗎？" : "要儲存成你的預設商務出差包嗎？"}
            </p>
            <div style={{ display: "flex", gap: 8 }}>
              <button onClick={onSaveComplete} style={{ flex: 1, padding: "10px", borderRadius: 10, border: "none", background: "#4C6E91", color: "white", fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 13, cursor: "pointer" }}>儲存</button>
              <button onClick={onDismissComplete} style={{ flex: 1, padding: "10px", borderRadius: 10, border: "1.5px solid #E2E8F0", background: "white", color: "#64748B", fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>不用</button>
            </div>
          </div>
        </div>
      </div>
