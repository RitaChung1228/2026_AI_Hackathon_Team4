  ...
  if (view === "agent-mission" && agentMission) {
    ...
    return (
      <div className="panel-enter" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        {/* Progress */}
        <div style={{ padding: "12px 16px 8px", background: "white", borderBottom: "1px solid #F1F5F9" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
            <span style={{ fontSize: 11, fontWeight: 600, color: "#4C6E91", fontFamily: "var(--font-display)" }}>進度 {prog}%</span>
            <span style={{ fontSize: 11, color: "#94A3B8" }}>{confirmedCount}/{tasks.length} 完成</span>
          </div>
          <div style={{ height: 4, background: "#F1F5F9", borderRadius: 2, overflow: "hidden" }}>
            <div style={{ height: "100%", width: `${prog}%`, background: "linear-gradient(90deg, #4C6E91, #6E92B4)", borderRadius: 2, transition: "width 0.5s ease" }} />
          </div>
        </div>

        {/* AI Summary */}
        {agentMission.aiSummary && (
          <div style={{ margin: "12px 16px 0", padding: "10px 14px", background: "linear-gradient(135deg, rgba(76,110,145,0.06), rgba(110,146,180,0.04))", border: "1px solid rgba(76,110,145,0.15)", borderRadius: 12 }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "12px 16px" }} className="scrollbar-hide">
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {tasks.map((task: any) => {
              ...
              return (
                <div key={task.id} style={{ background: "white", borderRadius: 12, padding: "12px 14px", border: "1px solid #E2E8F0", display: "flex", alignItems: "center", gap: 12 }}>
                  {task.imgUrl ? (
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 13, color: "#16232E", marginBottom: 2 }}>{task.title}</div>
                    <div style={{ fontSize: 11, color: "#64748B", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{task.detail}</div>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, flexShrink: 0 }}>
                    ...
                    {bookableId && (
                      <button
                        ...
                        style={{ fontSize: 10, fontWeight: 700, padding: "3px 9px", borderRadius: 20, border: "none", cursor: inCart ? "default" : "pointer", background: inCart ? "#DCFCE7" : "#4C6E91", color: inCart ? "#16A34A" : "white", fontFamily: "var(--font-display)", whiteSpace: "nowrap" }}
                      >
      ...
      <div className="panel-enter" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        {mission.aiSummary && (
          <div style={{ margin: "10px 12px 0", background: "linear-gradient(135deg, rgba(76,110,145,0.07), rgba(110,146,180,0.04))", border: "1px solid rgba(76,110,145,0.14)", borderRadius: 10, padding: "8px 12px", display: "flex", gap: 8, flexShrink: 0 }}>
            <span style={{ fontSize: 12, color: "#4C6E91", flexShrink: 0 }}>✦</span>
                    ...
                    <div style={{ borderTop: "1px solid #F1F5F9", background: "#FAFCFE", padding: "8px 10px 10px" }}>
                      ...
                      {task.id === "checklist" && view === "moving" && (
                        <div style={{ marginBottom: 6 }}>
                          ...
                          {checklistItems.length === 0 && (
                            <div style={{ fontSize: 11, color: "#A9C0D6", textAlign: "center", padding: "6px 0" }}>還沒有項目，輸入後按 ＋ 加入</div>
                          )}
                        </div>
                      )}
                          ...
                          <div style={{ marginBottom: 6 }}>
                            ...
                            {calorieConfirmed && kcal > 0 && (
                              <>
                                ...
                                <div style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", letterSpacing: "0.6px", marginBottom: 6, fontFamily: "var(--font-display)" }}>✦ AI 推薦食物</div>
                                <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                                  {FOOD_RECS.map((food) => (
                      ...
                      {task.id === "schedule" && view === "fitness" && (
                        <div style={{ marginBottom: 6 }}>
                          ...
                          <div style={{ marginTop: 8, padding: "6px 10px", background: "#E7EEF5", borderRadius: 8, fontSize: 10, color: "#4C6E91", fontWeight: 600, fontFamily: "var(--font-display)" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "stretch" }}>
                    ...
                    <div style={{ flex: 1, padding: "10px 10px 10px 12px", display: "flex", alignItems: "center", gap: 8 }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: 10, color: "#4C6E91", display: "flex", alignItems: "center", gap: 3, marginTop: 2 }}><span>✦</span>{p.reason}</div>
                      </div>
                      <div style={{ textAlign: "right", flexShrink: 0 }}>
                        <div style={{ fontSize: 14, fontWeight: 800, color: "#16232E", fontFamily: "var(--font-display)", marginBottom: 4 }}>NT${p.price}</div>
                        <button
                          onClick={() => addProduct(p)}
                          style={{ padding: "4px 12px", borderRadius: 20, border: added ? "1.5px solid #16A34A" : "none", background: added ? "white" : "#4C6E91", color: added ? "#16A34A" : "white", fontSize: 11, fontWeight: 600, cursor: added ? "default" : "pointer", fontFamily: "var(--font-display)", whiteSpace: "nowrap" }}
                        >
                          {added ? "✓ 加入" : "加入"}
                        </button>
                      </div>
      ...
      return (
        <div className="panel-enter" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 32px", textAlign: "center" }}>
            <div style={{ width: 64, height: 64, borderRadius: "50%", background: "#E7EEF5", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 26, marginBottom: 14 }}>
              🛒
            </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "10px 12px" }} className="scrollbar-hide">
          {cartItems.map((item) => (
            <div key={item.id} style={{ background: "white", borderRadius: 12, padding: "10px 12px", marginBottom: 8, border: "1px solid #F1F5F9", display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <button onClick={() => onCartUpdate(cartItems.filter((i) => i.id !== item.id))} style={{ background: "#F1F5F9", border: "none", borderRadius: "50%", width: 22, height: 22, cursor: "pointer", fontSize: 11, color: "#94A3B8", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>✕</button>
            </div>
          ))}
        ...
        {confirmingCheckout && (
          <div style={{ position: "absolute", inset: 0, background: "rgba(22,35,46,0.5)", display: "flex", alignItems: "flex-end", zIndex: 100 }}>
            <div className="slide-up" style={{ background: "white", borderRadius: "18px 18px 0 0", padding: "22px 22px 36px", width: "100%" }}>
              ...
              <p style={{ textAlign: "center", fontSize: 13, color: "#64748B", marginBottom: 18 }}>共 {cartItems.length} 件 · NT${total.toLocaleString()}</p>
